...
class mk_main_menu extends Walker_Nav_Menu
{
    ...
    function start_lvl(&$output, $depth = 0, $args = array()) {
        ...
        $output.= "\n$indent<div class=\"layout-sub-menu\"><ul style=\"$style\" class=\"sub-menu {locate_class}\">\n";
    }
...
class header_icon_walker extends Walker_Nav_Menu
{
    ...
    function start_lvl(&$output, $depth = 0, $args = array()) {
        $indent = str_repeat("\t", $depth);
        $output.= '<span class="menu-sub-level-arrow">'.Mk_SVG_Icons::get_svg_icon_by_class_name(false, 'mk-icon-angle-right', 12).'</span>';
