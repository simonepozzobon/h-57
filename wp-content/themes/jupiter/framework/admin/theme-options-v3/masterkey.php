...
$options = array(
    'menu'   => array(
        ...
        'elements' => array(
            'label'   => __( 'Elements', 'mk_framework' ),
			'default' => 'typography',
            'submenu' => array(
                ...
                array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'help' => __( 'Define when Main Navigation should viewed as Responsive Navigation. Default is 1140 pixels but if your Navigation items fits in header in smaller widths you can change this value. For example, if you wish to view your website in iPad and see Main Navigtion as you see in desktop, then you should change this value to any size below 1020 pixels.' ),
                ...
                array(
                    ...
                    'fields' => array(
        				...
        				array(
                            ...
                            'help' => sprintf(__("Choose a menu location as a global main navigation for logged in users. You should first <a target='_blank' href='%s'>create menu</a> and then <a target='_blank' href='%s'>assign to menu locations.</a>", "mk_framework"), admin_url('nav-menus.php'), admin_url('nav-menus.php') . "?action=locations" ),
        		            'model' => 'loggedin_menu',
        		            'default' => '',
        		            'options' => mk_assoc_to_pairs( array(
								'' => __('Select Option', 'mk_framework'),
            ...
            'sections' => array(
                array(
                    ...
                    'fields' => array(
                		...
                		array(
                            'label' => __('Show on Mobile', 'mk_framework') ,
                            'help' => __('', 'mk_framework') ,
                ...
                array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'default' => '',
                            'options' => MK_Theme_Option::get_post_types(),
                            'type' => 'mk-select-multi',
                            'styleClasses' => 'col-sm-12'
                        ) ,
                    )
            ...
            'sections' => array(
                array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            'label' => __( 'Intelligent Components Technology', 'mk_framework' ),
                            'help' => __( 'If you disable this option your web site will serve all component assets even it\'s not needed. In some exceptional cases Intelligent Components Technology can cause problems with your hosting such as:  <br />
