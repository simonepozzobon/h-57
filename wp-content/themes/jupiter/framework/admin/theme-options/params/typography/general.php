...
$typography_section[] = array(
    ...
    "fields" => array(
       array(
        ...
        "desc" => __( 'Adjust default body text size.', 'mk_framework' ),
        "id" => "body_font_size",
        "min" => "10",
        "max" => "50",
        "step" => "1",
    ...
    array(
        ...
        "desc" => __( 'Adjust default body text line height.', 'mk_framework' ),
        "id" => "body_line_height",
        "min" => "1",
        "max" => "4",
        "step" => "0.01",
    ...
    array(
        ...
        "id" => "body_weight",
        "desc" => __( 'Choose default body text weight.', 'mk_framework' ),
        "default" => 400,
        "type" => "font_weight"
    ),
    array(
        "name" => __('Paragraph (p) Text Size', "mk_framework"),
        "desc" => __("Adjust default paragraph text size.", "mk_framework"),
        "id" => "p_size",
        "min" => "10",
        "max" => "50",
        "step" => "1",
    ...
    array(
        ...
        "desc" => __("Adjust default paragraph text line height.", "mk_framework"),
        "id" => "p_line_height",
        "min" => "1",
        "max" => "4",
        "step" => "0.01",
