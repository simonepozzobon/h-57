...
$typography_section[] = array(
    ...
    "fields" => array(
       array(
        ...
        "desc" => __("Adjust the blog posts text size. Set it to 0 to use the default body text size from <strong>General Typography</strong>.", "mk_framework"),
    ...
    array(
        ...
        "desc" => __("Adjust the blog posts text line height. Set it to 0 to use the default body text line height from <strong>General Typography</strong>.", "mk_framework"),
    ...
    array(
        ...
        "desc" => __("Adjust single blog posts title size. Set it to 0 to use the default body text size  from <strong>General Typography</strong>.", "mk_framework"),
        "min" => "0",
        "max" => "50",
        "step" => "1",
        "unit" => 'px',
