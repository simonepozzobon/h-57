...
$typography_section[] = array(
    ...
    "fields" => array(
        array(
            ...
            "id" => "font_family",
            "desc" => __("Choose a set of safe font family. These font families will be used as backup font (If the below none-safe fonts failed to load for any reason) and be applied to all site elements.", "mk_framework") ,
            "default" => '',
            "options" => array(
        ...
        array(
            ...
            "fields" => array(
                ...
                array(
                    ...
                    "desc" => __("Choose your desired character sets here as a comma separated list. This option is going to work if you choose Google Fonts and need to have glyphs other than English.", "mk_framework") ,
                ...
                array(
                    ...
                    "desc" => __("Choose elements that you would like to set for the above font family. Setting it to Body will affect all elements.", "mk_framework") ,
        ...
        array(
            ...
            "fields" => array(
                ...
                array(
                    "name" => __("Site Elements to Set.", "mk_framework") ,
                    "desc" => __("Choose elements that you would like to set for the above font family. Setting it to Body will affect it all elements.", "mk_framework") ,
