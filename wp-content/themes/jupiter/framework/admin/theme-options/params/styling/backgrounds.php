...
$styling_section[] = array(
    ...
    "fields" => array(
        ...
        array(
            ...
            "desc" => __("Adjust the outer shadow size for boxed layout.", "mk_framework") ,
        ...
        array(
            ...
            "desc" => __("Adjust the opacity of the outer shadow for boxed layout.", "mk_framework") ,
        ...
        array(
            ...
            "desc" => __("Expand the page title section (background image, color) to to header section?", "mk_framework") ,
        ...
        array(
            ...
            "desc" => __("Modify header, page title, body and footer background properties. Click on each section to customize it.", 'mk_framework') ,
