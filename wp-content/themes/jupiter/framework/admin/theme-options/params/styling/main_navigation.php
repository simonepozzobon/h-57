...
$styling_section[] = array(
    ...
    "fields" => array(
       array(
        ...
        "desc" => __("Select hover style of main navigation items. Consider that hover style 5 does not work in header style 4.", "mk_framework"),
        "id" => "main_nav_hover",
        "default" => "5",
        "options" => array(
        ...
        "desc" => __("Select background color for main navigation items of header style 2.", "mk_framework"),
    ...
    array(
        ...
        "desc" => __("Select color for the main menu hover & current menu item hover skin color. This color will be applied to the hover style you have chosen in above option (Header Main Navigation Hover Style).", "mk_framework"),
    ...
    array(
        ...
        "desc" => __("Select color for main navigation hover style 3 current item text color and style 4 current & hover text color.", "mk_framework"),
    ...
    array(
        ...
        "desc" => __("Clear the color, if you want to hide the border.", "mk_framework"),
    ...
    array(
     ...
     array(
        ...
        "desc" => __("Display shadow for menu sub level boxes.", "mk_framework"),
        "id" => "nav_sub_shadow",
        "default" => 'false',
        "type" => "toggle"
    ),
    ...
    array(
        ...
        "desc" => __("Select mega menu vertical dividers color. Clear the color to hide the dividers.", "mk_framework"),
