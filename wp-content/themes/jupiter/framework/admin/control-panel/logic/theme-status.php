...
$sysinfo = mk_control_panel::compileSystemStatus( false, true );
 ?>
 ...
 <div class="control-panel-holder">
	...
	<div class="status-page cp-pane">
			<h3><?php _e( 'System Status', 'mk_framework' ); ?></h3>
...
?>            
        ...
        <?php if ( function_exists( 'ini_get' ) ) { ?>
            ...
            <tr>
                ...
                <td class="help">
                    ...
                    <span class="mk-tooltip--text">
                        <?php echo esc_attr__( 'max_execution_time : The amount of time (in seconds) that your site will spend on a single operation before timing out (to avoid server lockups).', 'mk_framework' ); ?>
                    </span>
                </td>
        ...
        <?php if ( $sysinfo['suhosin_installed'] == true ) {?>
                <tr>
                    <td data-export-label="PHP Max Input Vars"><?php esc_html_e( 'Suhosin Max Request Vars', 'mk_framework' ); ?>:</td>
                    <td class="help">
                        <?php echo '<a href="#" class="mk-hint mk-tooltip--link"></a>'; ?>
                        <span class="mk-tooltip--text">
                        <?php echo esc_attr__( 'The maximum number of variables your server running Suhosin can use for a single function to avoid overloads.', 'mk_framework' ); ?>
                    </span>
                    </td>
                    <td><?php echo esc_html($sysinfo['suhosin_request_max_vars']); ?></td>
                </tr>
                <tr>
                    <td data-export-label="PHP Max Input Vars"><?php esc_html_e( 'Suhosin Max Post Vars', 'mk_framework' ); ?>:</td>
                    <td class="help">
                        <?php echo '<a href="#" class="mk-hint mk-tooltip--link"></a>'; ?>
                        <span class="mk-tooltip--text">
                        <?php echo esc_attr__( 'The maximum number of variables your server running Suhosin can use for a single function to avoid overloads.', 'mk_framework' ); ?>
...
?>
        ...
        <tr>
            ...
            <td data-export-label="PHP XML">
                <?php esc_html_e( 'PHP XML', 'mk_framework' ); ?>:
            </td>
            <td class="help">
                <?php echo '<a href="#" class="mk-hint mk-tooltip--link"></a>'; ?>
                <span class="mk-tooltip--text">
                    <?php echo esc_attr__( 'Theme requires PHP XML Library to be installed.', 'mk_framework' ); ?>
                </span>
            </td>
            <td>
                <?php
                if ( $sysinfo['phpxml'] === 'false' ) {
                    echo '<span class="status-invisible">False</span><span class="status-state status-false"></span> ' . sprintf( __( 'PHP XML PHP Library should be installed', 'mk_framework' ));
                } else {
                    echo '<span class="status-invisible">True</span><span class="status-state status-true"></span>';
                }
                ?>
        ...
        <tr>
            <td data-export-label="MBString">
                <?php esc_html_e( 'MBString', 'mk_framework' ); ?>:
            </td>
            <td class="help">
                <?php echo '<a href="#" class="mk-hint mk-tooltip--link"></a>'; ?>
                <span class="mk-tooltip--text">
                    <?php echo esc_attr__( 'Theme requires MBString PHP Library to be installed.', 'mk_framework' ); ?>
                </span>
            </td>
            <td>
                <?php
                if ( $sysinfo['mbstring'] === 'false' ) {
                    echo '<span class="status-invisible">False</span><span class="status-state status-false"></span> ' . sprintf( __( 'MBString PHP Library should be installed', 'mk_framework' ));
                } else {
                    echo '<span class="status-invisible">True</span><span class="status-state status-true"></span>';
                }
                ?>
        ...
        <tr>
            <td data-export-label="SimpleXML">
                <?php esc_html_e( 'SimpleXML', 'mk_framework' ); ?>:
            </td>
            <td class="help">
                <?php echo '<a href="#" class="mk-hint mk-tooltip--link"></a>'; ?>
                <span class="mk-tooltip--text">
                    <?php echo esc_attr__( 'Theme requires SimpleXML PHP Library to be installed.', 'mk_framework' ); ?>
                </span>
            </td>
            <td>
                <?php
                if ( $sysinfo['simplexml'] === 'false' ) {
                    echo '<span class="status-invisible">False</span><span class="status-state status-false"></span> ' . sprintf( __( 'SimpleXML PHP Library should be installed', 'mk_framework' ));
                } else {
                    echo '<span class="status-invisible">True</span><span class="status-state status-true"></span>';
                }
                ?>
        ...
        <?php
            ...
            // fsockopen/cURL
            $posting['fsockopen_curl']['name'] = esc_html__( 'fsockopen/cURL', 'mk_framework' );
            ...
            // SOAP
            $posting['soap_client']['name'] = esc_html__( 'SoapClient', 'mk_framework' );
            ...
            // DOMDocument
            $posting['dom_document']['name'] = esc_html__( 'DOMDocument', 'mk_framework' );
            ...
            // GZIP
            $posting['gzip']['name'] = esc_html__( 'GZip', 'mk_framework' );
