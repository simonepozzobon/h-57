...
$portfolio_section[] = array(
    "type" => "sub_group",
    "id" => "mk_options_portfolio_single_post_section",
    "name" => __("Portfolio / Portfolio Single Post", "mk_framework") ,
    ...
    "fields" => array(
        ...
        array(
            "name" => __("Related Portfolio Posts", "mk_framework") ,
        ...
        array(
            "name" => __("Previous & Next for Same Categories", "mk_framework") ,
        ...
        array(
            "name" => __("Comments on Portfolio Post", "mk_framework") ,
