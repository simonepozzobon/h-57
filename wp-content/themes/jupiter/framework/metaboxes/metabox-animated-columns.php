...
$options = array(
	...
	array(
        ...
        "desc" => __( "<a target='_blank' href='".admin_url( 'admin.php?page=Jupiter#mk-cp-icon-library')."'>Click here</a> to get the icon class name (or any other font icons library that you have installed in the theme)", "mk_framework" ),
        "id" => "_icon",
        "default" => "",
        "type" => "text",
         "dependency" => array(
