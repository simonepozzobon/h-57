...
<?php endif; ?>
	...
	$fields   = array(
		'author'  => '<div class="comment-form-name comment-form-row"><input type="text" name="author" value="' . esc_attr( $commenter['comment_author'] ) . '" class="text_input" id="author" tabindex="' . esc_attr( $tab_index++ ) . '" placeholder="' . esc_html__( 'Name (Required)', 'mk_framework' ) . '"' . $html_req . ' maxlength="245" /></div>',

		'email'   => '<div class="comment-form-email comment-form-row"><input type="email" name="email" class="text_input" id="email" tabindex="' . esc_attr( $tab_index++ ) . '" placeholder="' . esc_html__( 'Email (Required)', 'mk_framework' ) . '" value="' . esc_attr( $commenter['comment_author_email'] ) . '" aria-describedby="email-notes"' . $html_req . ' maxlength="100" /></div>',
